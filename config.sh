...
TOMCAT_DIR="/home/kunaljaykam/sakaiproject/apache-tomcat-9.0.83"

# Path to the Sakai home directory
SAKAI_HOME="/home/kunaljaykam/sakaiproject/sakai-home"

# URL to download Tomcat
# Update this URL if you need a different version of Tomcat(https://tomcat.apache.org/download-90.cgi)
